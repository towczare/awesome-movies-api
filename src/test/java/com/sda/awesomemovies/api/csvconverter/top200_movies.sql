...
VALUES (id, 'title', 'https://image.tmdb.org/t/p/w300_and_h450_bestv2/poster_path', 'overview', rating);
INSERT INTO movie_category
VALUES (id, (SELECT category_id FROM category WHERE name = 'genres'));
...
VALUES (38288,
        ...
        8.2);
INSERT INTO movie_category
VALUES (38288, (SELECT category_id FROM category WHERE name = 'x'));
